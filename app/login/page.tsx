  ...
  return (
    <div className="min-h-screen w-full lg:grid lg:grid-cols-2 bg-[#090d16] text-white overflow-hidden">
      ...
      <motion.div 
        ...
        className="hidden lg:flex flex-col justify-between p-12 xl:p-20 border-r border-slate-800/80 bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-slate-900/60 via-[#090d16] to-[#090d16] relative"
      >
        ...
        <div className="relative z-10 space-y-6">
          ...
          <h1 className="text-4xl xl:text-5xl font-bold tracking-tight leading-[1.15]" style={{ fontFamily: 'Outfit, sans-serif' }}>
            Project management built for teams <span className="text-indigo-400">that ship fast.</span>
          </h1>
          
          <p className="text-slate-400 max-w-md text-sm xl:text-base leading-relaxed">
            Coordinate projects, track tasks, and keep your team aligned — all from a single, powerful workspace.
          </p>
        </div>

        <div className="relative z-10 grid grid-cols-3 gap-6 pt-12 border-t border-slate-800/80">
          <div>
        ...
        >
          ...
          <div className="space-y-3 pt-6 border-t border-slate-800/80">
            <span className="text-xs font-medium text-slate-400 uppercase tracking-wider flex items-center gap-1.5">
              ...
              Quick Access — Admin Account
            </span>
            
            <div 
              onClick={() => fillDemo('admin@nexus.io')}
              className="flex items-center justify-between p-3.5 rounded-xl bg-slate-900/50 hover:bg-slate-900 border border-slate-800/80 cursor-pointer transition-all group"
            >
              <div className="flex items-center gap-3">
                <span className="w-2.5 h-2.5 rounded-full bg-blue-500 shadow-sm shadow-blue-500/50"></span>
                <span className="text-sm font-medium text-slate-200 group-hover:text-indigo-400 transition-colors">Muhammad Zaryab Khalid (Admin)</span>
              </div>
              <span className="text-xs text-slate-500 font-mono">admin@nexus.io</span>
            </div>
          </div>
        </motion.div>
      </div>
